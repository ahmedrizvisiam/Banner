<h1 align="center">Banner-Termux</h1>

<p align="center"> 
  <img src="https://img.shields.io/github/stars/Cod3r-Ak/Banner-Termux?style=for-the-badge&color=orange">
  <img src="https://img.shields.io/github/forks/Cod3r-Ak/Banner-Termux?color=cyan&style=for-the-badge&color=purple">
  <img src="https://img.shields.io/github/license/Cod3r-Ak/Banner-Termux?style=for-the-badge&color=blue"><br>
<br>
<br>
...
**Repository Views** ![Views](https://profile-counter.glitch.me/Banner-Termux/count.svg) 
...
## Screenshorts After installing Banner-Termux
### Login Screen
...
[-] Clone the Banner-Termux6 repository in your Termux:
    ```
    git clone https://github.com/Cod3r-Ak/Banner-Termux
    ```
...
```
apt update && apt upgrade && pkg install git && git clone https://github.com/Cod3r-Ak/Banner-Termux && cd Banner-Termux && chmod +x * && bash setup.sh 
```
## Copyright Notice
