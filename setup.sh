...
cd $HOME/Banner-Termux
cp login.sh $PREFIX/etc
chmod +x login.sh delete.sh setup.sh sound_effect.py banner.sh update.sh
mkdir -p $HOME/Banner-Termux/Song 
mv Access-Granted.mp3 Jarvis2.mp3 JARVIS.mp3 sound_effect.py $HOME/Banner-Termux/Song
rm 1
mkdir -p $HOME/Banner-Termux/NETWORK
mv network.py $HOME/Banner-Termux/NETWORK
